...
def background_task(job_id, video_id, target_lang, url):
    try:
        results = process_subtitles(url, target_lang)
...
def process():
    ...
    Thread(target=background_task, args=(job_id, video_id, target_lang, url)).start()
